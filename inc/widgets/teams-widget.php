            ...
            <?php if ( $get_featured_pages->have_posts() ) : ?>
              <div class="entry-content">
                <?php while( $get_featured_pages->have_posts() ) : $get_featured_pages->the_post(); 
                  ...
                  $team_designation   = get_post_meta( $post->ID, 'aop_team_designation', true );
                  $team_social_1      = get_post_meta( $post->ID, 'aop_team_social_1', true );
                  $team_social_2      = get_post_meta( $post->ID, 'aop_team_social_2', true );
                  $team_social_3      = get_post_meta( $post->ID, 'aop_team_social_3', true );
