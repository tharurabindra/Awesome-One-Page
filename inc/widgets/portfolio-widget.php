 ...
 */
class aop_portfolio_widget extends WP_Widget {
  function __construct() {
      $widget_ops = array( 'classname' => 'widget_portfolio_block', 'description' => esc_html__( 'Display some pages as portfolio.', 'awesome-one-page' ) );
      $control_ops = array( 'width' => 200, 'height' =>250 );
        parent::__construct( false, $name = esc_html__( 'AOP: Portfolio', 'awesome-one-page' ), $widget_ops, $control_ops);
    }
    ...
    function form( $instance ) {
      ...
      <div class="aop-portfolio">
        <div class="aop-admin-input-wrap">
          <p><?php esc_html_e('This widget displays all pages related to Single Portfolio Template.', 'awesome-one-page'); ?></p>
          <p><em><?php esc_html_e('Tip: to rearrange the portfolio order, edit each portfolio page and add a value in Page Attributes > Order', 'awesome-one-page'); ?></em></p>
          ...
          <ul class="aop-widget-repetable-field-items">
            <li class="aop-widget-accordion-item">
              ...
              <div class="accordion-content">
                ...
                <div class="aop-admin-input-wrap">
                  <p><em><?php esc_html_e('Tip: Enter the Portfolio Section ID and use same for Menu item. Only used for One Page Menu.', 'awesome-one-page'); ?></em></p>
                </div><!-- .aop-admin-input-wrap -->
      ...
      $get_featured_pages = new WP_Query( array(
        ...
        'meta_query'      => array(
            array(
              ...
              'value' => 'page-templates/template-portfolio.php'
            )
          )
      ) );
