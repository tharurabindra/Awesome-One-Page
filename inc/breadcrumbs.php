...
function awesome_one_page_breadcrumbs(){
  /* === OPTIONS === */
	...
	if (is_home() || is_front_page()) {
		if ($showOnHome == 1) echo '<div id="aop-breadcrumbs"><a href="' . $homeLink . '">' . $text['home'] . '</a></div>';
	} else {
		echo '<div id="aop-breadcrumbs" xmlns:v="http://rdf.data-vocabulary.org/#">' . sprintf($link, $homeLink, $text['home']) . $delimiter;
